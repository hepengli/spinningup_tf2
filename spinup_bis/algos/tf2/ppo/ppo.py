...
from spinup_bis.algos.tf2.ppo import core
...
def ppo(env_fn, actor_critic=core.mlp_actor_critic, ac_kwargs=None, seed=0,
        total_steps=int(1e6), train_every=4000, log_every=4000, gamma=0.999,
        clip_ratio=0.2, pi_lr=3e-4, v_lr=1e-3, train_pi_iters=80,
